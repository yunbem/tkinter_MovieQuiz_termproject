...
class MovieQuery:
    ...
    def getSimilarGenreMovies(self, query):
        ...
        similar_movies = [movie for movie in self.data
                          ...
                          and movie['id'] not in self.added_movies
                          and movie not in self.bookmarks][:10]

        self.added_movies.update(movie['id'] for movie in similar_movies)
